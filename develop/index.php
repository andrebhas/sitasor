...
<html>
    <head>
        <title>Developer tools | Andre Bhaskoro</title>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-md-9">
                <h3 style="margin-top: 0px">CRUD Generator 1.3.1 by <a target="_blank" href="http://bhas.web.id">Andre Bhaskoro</a></h3>
                ...
                <p>
                    Please visit and like <a target="_blank" href="http://bhas.web.id">Bhas.web.id</a><b> for more info and PHP tutorials.
                </p>
                ...
                <p>Buy me a cup of coffee :)</p>
                    <form action="http://bhas.web.id" method="post" target="_top">
                ...
                <p><strong>&COPY; 2013 - 2016 <a target="_blank" href="http://bhas.web.id">bhas.web.id</a></strong></p>
            </div>
        </div>
